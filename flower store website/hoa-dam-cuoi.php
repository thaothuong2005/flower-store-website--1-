...
/* Cho nút yêu thích nằm trên nút giỏ hàng (2 dòng) */
.flex-btn {
   display: flex;
...
<h1 class="title">Hoa đám cưới</h1>
<div class="box-container">
<?php
$select_products = mysqli_query($conn, "SELECT * FROM products WHERE category='dam-cuoi'") or die('query failed');
